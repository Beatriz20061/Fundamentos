...
st.sidebar.caption("ISCTE Sintra — 2026")
...
if page == "🏠 Página Inicial":
    ...
    ### 📂 Mapeamento dos Projetos Originais:
    * **Módulo 1 (FM_4ºprojeto.pdf):** Investigação da distribuição de primos na reta, Espiral de Ulam e Função Totiente de Euler.
    * **Módulo 2 (trabalho_5_novo.pdf):** Números Triangulares, Números Perfeitos, as propriedades cíclicas do Número 9 e o Último Teorema de Fermat.
    * **Módulo 3 (FM_3ºProjeto__Copy_.pdf):** Modelação proposicional, Teoria de Grafos e Combinatória de paridade aplicadas ao jogo *Number Match*.
    * **Módulo 4 (FM_1ºprojeto .pdf):** Axiomas de Grupos, Isometrias lineares, Caleidoscópios, a arte de Escher e as cápsides de vírus icosaédricos.
    * **Módulo 5 (FM_2ºProjeto.pdf):** Estudo e classificação definitiva de todas as pavimentações periódicas através dos 17 Grupos Cristalográficos do Plano.
    """)
...
# ==============================================================================
    ...
    st.markdown('<div class="academic-header"><h1>🟣 Módulo 1: Padrões dos Primos – Da Espiral à Totiente</h1><p>Relatório Original: <b>FM_4ºprojeto.pdf</b> | Autoras: Catarina Pereira, Beatriz Correia | Março 2026</p></div>', unsafe_allow_html=True)
    
    tab1, tab2 = st.tabs(["📖 Matéria Completa & Aplicações", "✍️ Quiz Geral do Módulo"])
    
    with tab1:
        with st.expander("1.1 A Natureza e Distribuição Irregular dos Números Primos", expanded=True):
            st.markdown("""
        ...
        with st.expander("1.3 A Função Totiente de Euler e Estrutura Multiplicativa Modular", expanded=True):
            st.markdown("""
            **Explicação Teórica Exaustiva:**
    ...
    with tab2:
        ...
        score1 = 0
        r1_1 = st.sidebar.markdown("") # Espaçador técnico
        
        # Correção das strings matemáticas adicionando marcas $$ explicativas
...
# ==============================================================================
    ...
    st.markdown('<div class="academic-header"><h1>🟡 Módulo 2: Padrões Numéricos e Estruturas Aritméticas</h1><p>Relatório Original: <b>trabalho_5_novo.pdf</b> | Autoras: Catarina Pereira, Beatriz Correia | Maio 2026</p></div>', unsafe_allow_html=True)
    
    tab1, tab2 = st.tabs(["📖 Matéria Completa & Gráficos", "✍️ Quiz Geral do Módulo"])
    
    with tab1:
        with st.expander("2.1 Números Triangulares e a Abordagem Geometrica de Contagem", expanded=True):
            st.markdown("""
            **Explicação Teórica Exaustiva:**
            ...
            **Aplicação Concreta no Quotidiano:**
            Os números triangulares possuem diversas aplicações práticas em problemas reais de contagem e organização. Um exemplo clássico é a modelação e contagem de ligações em redes de comunicação ou interações entre indivíduos. Se tivermos uma sala com 6 pessoas e quisermos saber quantos apertos de mão únicos ocorrem se todas se cumprimentarem uma única vez, o cálculo resolve-se através do número triangular $T_{5}$:
            """)
        ...
        with st.expander("2.4 O Último Teorema de Fermat e a Limitação de Padrões", expanded=True):
            st.markdown("""
            **Explicação Teórica Exaustiva:**
            ...
            st.markdown("""
            **não admite qualquer tipo de solução inteira não trivial** sempre que o expoente $n$ for um número estritamente maior do que 2 ($n>2$). Ao alterarmos apenas o valor do expoente da equação, passamos de um sistema rico em soluções infinitas para um vazio total. A prova universal e definitiva só foi alcançada em 1994 por Andrew Wiles, utilizando conceitos contemporâneos sofisticados como curvas elípticas.
            """)
    ...
    with tab2:
        ...
        # EMBED COMPLETO DO LATEX EM TODAS AS OPÇÕES DO APP
...
# ==============================================================================
    ...
    st.markdown('<div class="academic-header"><h1>🔵 Módulo 4: Introdução aos Grupos de Simetria</h1><p>Relatório Original: <b>FM_1ºprojeto .pdf</b> | Autoras: Catarina Pereira, Beatriz Correia | Março 2026</p></div>', unsafe_allow_html=True)
    
    tab1, tab2 = st.tabs(["📖 Matéria Completa & Isometrias", "🧠 Quiz Geral do Módulo"])
    
    with tab1:
        with st.expander("4.1 Isometrias e Estrutura Abstrata da Teoria de Grupos", expanded=True):
            st.markdown("""
            **Explicação Teórica Exaustiva:**
        ...
        with st.expander("4.2 Eficiência Viral e Simetrias na Natureza e na Arte", expanded=True):
            st.markdown("""
            **Explicação Teórica Exaustiva:**
...
# ==============================================================================
elif page == "Módulo 5: 17 Grupos Cristalográficos":
    st.markdown('<div class="academic-header"><h1>🟤 Módulo 5: Os 17 Grupos Cristalográficos do Plano</h1><p>Relatório Original: <b>FM_2ºProjeto.pdf</b> | Autoras: Catarina Pereira, Beatriz Correia | Março 2026</p></div>', unsafe_allow_html=True)
    
    tab1, tab2 = st.tabs(["📖 Matéria Completa & Classificação", "🧠 Quiz Geral do Módulo"])
    
    with tab1:
        with st.expander("5.1 Grupos de Simetria e as Restrições das Tesselações Periódicas", expanded=True):
            st.markdown("""
            **Explicação Teórica Exaustiva:**
        ...
        with st.expander("5.2 Análise Comparativa Profunda dos Subgrupos p4, p6 e pm", expanded=True):
            st.markdown("""
